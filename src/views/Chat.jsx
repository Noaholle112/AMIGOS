        ...
        <div className="no-scrollbar flex-1 space-y-2 overflow-y-auto">
          {matches.map((m) => {
            ...
            return (
              ...
              >
                <Avatar photo={m.photo} objectPosition={m.objectPosition} emoji={m.avatar} size={52} />
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-3 border-b border-secondary/10 bg-white px-4 py-3">
        ...
        <Avatar photo={user.photo} objectPosition={user.objectPosition} emoji={user.avatar} size={40} />
        <div>
